...
#changed from 400
tf.app.flags.DEFINE_integer('max_enc_steps', 1200, 'max timesteps of encoder (max source text tokens)')
#changed from 100
...
#changed from 50000 to 100000
tf.app.flags.DEFINE_integer('vocab_size', 50000, 'Size of vocabulary. These will be read from the vocabulary file in order. If the vocabulary file contains fewer words than this number, or if this number is set to 0, will take all words in the vocabulary file.')
#changed from 0.1 -> 0.15 -> 0.2
tf.app.flags.DEFINE_float('lr', 0.1, 'learning rate')
tf.app.flags.DEFINE_float('adagrad_init_acc', 0.1, 'initial accumulator value for Adagrad')
#changed from 0.02 default to 0.05
tf.app.flags.DEFINE_float('rand_unif_init_mag', 0.05, 'magnitude for lstm cells random uniform inititalization')
